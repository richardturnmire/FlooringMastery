...
namespace FlooringMastery.UI.Menus
{
	public class TaxMenu
	{
		public static void Start()
		{
			...
			{
				Console.Clear();
				Output.SendToConsole("Flooring Mastery Tax Menu");
				Output.SendToConsole("---------------------------------");
				Output.SendToConsole("1. List States");
				Output.SendToConsole("2. Add a State");
				Output.SendToConsole("3. Edit a State");
				Output.SendToConsole("4. Remove a State");
				Output.SendToConsole();
				...
				{
					case "1":
						TaxListWorkflow taxListWorkflow = DIContainer.Kernel.Get<TaxListWorkflow>();
						taxListWorkflow.Execute();
						break;
					case "2":
